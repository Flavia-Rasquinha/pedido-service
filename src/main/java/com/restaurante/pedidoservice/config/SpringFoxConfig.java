package com.restaurante.pedidoservice.config;
...
public class SpringFoxConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.OAS_30)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.restaurante.pedidoservice.controller"))
                .paths(PathSelectors.regex("/.*"))
                .build()
                .useDefaultResponseMessages(false)
                .apiInfo(new ApiInfoBuilder().title("Pedido service").build());
    }
}
